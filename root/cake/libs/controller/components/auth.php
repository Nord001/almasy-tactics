        ...
        if ($loginAction == $url) {
            ...
            if (!$this->user()) {
                if (!$this->RequestHandler->isAjax()) {
                    $this->Session->setFlash($this->GameAuthError, 'default', array(), 'auth');
 ...
 */
    function hashPasswords($data) {
        if (is_object($this->GameAuthenticate) && method_exists($this->GameAuthenticate, 'hashPasswords')) {
            return $this->GameAuthenticate->hashPasswords($data);
        }
